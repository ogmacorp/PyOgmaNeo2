...
namespace pyogmaneo {
    ...
    public:
        ...
        void step(PyComputeSystem &cs, const std::vector<std::vector<float> > &visibleActs, bool learnEnabled);
        ...
        const std::vector<float> &getVisibleActs(int index) const {
            return _enc.getVisibleLayer(index)._visibleActs;
        }
